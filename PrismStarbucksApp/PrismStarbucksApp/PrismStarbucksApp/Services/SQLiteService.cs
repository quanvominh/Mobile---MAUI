...
namespace PrismStarbucksApp.Services
{
    public class SqLiteService : ISqLiteService
    {
        ...
        protected const string DatabaseName = "NoName.db3";
        ...
        private void Init()
        {
            try
            {
                ...
                _database = new SQLiteConnection(dbPath); // DbConnection.SqliteConnection(DatabaseName);
